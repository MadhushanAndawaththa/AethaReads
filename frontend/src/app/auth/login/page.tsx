      ...
      <div className="w-full max-w-md">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            <div className="flex items-center justify-between mb-1.5">
              ...
              <Link href="/auth/forgot-password" className="text-xs text-brand-500 hover:text-brand-400">
                Forgot password?
              </Link>
            </div>
            <input
        ...
        <div className="mt-6">
          ...
          <a
            ...
            className="mt-4 w-full flex items-center justify-center gap-3 py-3 px-4 border border-[var(--border-color)] rounded-lg hover:bg-[var(--bg-secondary)] transition text-[var(--text-secondary)] text-sm font-medium"
          >
